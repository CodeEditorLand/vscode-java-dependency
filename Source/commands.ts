...
export namespace Commands {
	...
	export const VIEW_EXPLORER_NEW_PACKAGE =
		"java.view.fileExplorer.newPackage";

	export const VIEW_PACKAGE_RENAME_FILE = "java.view.package.renameFile";

	export const VIEW_PACKAGE_MOVE_FILE_TO_TRASH =
		"java.view.package.moveFileToTrash";

	export const VIEW_PACKAGE_DELETE_FILE_PERMANENTLY =
		"java.view.package.deleteFilePermanently";

	export const VIEW_PACKAGE_REVEAL_IN_PROJECT_EXPLORER =
	...
	export const VIEW_MENUS_FILE_NEW_JAVA_CLASS =
	...
	export const JAVA_PROJECT_RELOAD_ACTIVE_FILE =
	...
	export const JAVA_PROJECT_LIST_SOURCE_PATHS =
	...
	export const JAVA_PROJECT_CHECK_IMPORT_STATUS =
	...
	export const WORKBENCH_ACTION_FILES_OPENFOLDER =
		"workbench.action.files.openFolder";

	export const WORKBENCH_ACTION_FILES_OPENFILEFOLDER =
