...
export namespace Context {
	...
	export const LANGUAGE_SUPPORT_INSTALLED: string =
		"java:languageSupportInstalled";
	export const NO_JAVA_PROJECT: string = "java:noJavaProjects";
	export const IMPORT_FAILED: string = "java:importFailed";
	export const WORKSPACE_CONTAINS_BUILD_FILES: string =
		"java:workspaceContainsBuildFiles";
