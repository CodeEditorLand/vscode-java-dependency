...
export class PrimaryTypeNode extends DataNode {
	...
	protected async loadData(): Promise<
		SymbolInformation[] | DocumentSymbol[] | undefined
	> {
		...
		return workspace
			.openTextDocument(Uri.parse(this.nodeData.uri))
			.then((doc) => {
	...
	protected get contextValue(): string {
		...
		if (
			this._rootNode?.getParent() instanceof ProjectNode &&
